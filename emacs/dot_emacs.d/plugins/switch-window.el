...
(defcustom switch-window-shortcut-style 'neo-dvpe
  ...
  :type '(choice (const :tag "Alphabet" 'alphabet)
		 ...
		 (const :tag "Neo-extened DVPE Layout" 'neo-dvpe))
  :group 'switch-window)
...
;; neo-extended dvpe: https://github.com/district10/neo_keyboard_layout
(defcustom switch-window-neo-extended-dvpe-shortcuts
  '("s" "t" "r" "l" "c" "d" "u" "i" "e" "o" "a")
  "The list of characters used when switch-window-shortcut-style is 'neo-extended dvpe'"
  :type 'list
  :group 'switch-window)
...
(defun switch-window-list-keys ()
  ...
  (cond ((eq switch-window-shortcut-style 'qwerty)
	...
	((eq switch-window-shortcut-style 'neo-dvpe)
         switch-window-neo-extended-dvpe-shortcuts)
